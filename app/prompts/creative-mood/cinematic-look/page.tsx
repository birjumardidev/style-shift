  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14 lg:max-w-5xl xl:max-w-6xl lg:px-8 lg:py-20">
      <nav className="mb-8 flex items-center gap-2 text-xs text-neutral-400 sm:text-sm lg:mb-10">
        ...
        <span>/</span>
        <span className="text-neutral-600">Cinematic Look</span>
      </nav>
      ...
      <article className="space-y-8 lg:space-y-10">
        <header>
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-neutral-500 lg:text-xl lg:leading-8 lg:max-w-3xl">
            Copy this prompt to turn any image into a cinematic scene with moody color grading and strong lighting.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          ...
          <p className="mt-3 text-sm leading-7 text-neutral-500 lg:text-base lg:leading-8 xl:text-lg">
            The prompt is tuned for cinematic color tones, controlled contrast, and mood lighting.
            That encourages the model to keep the subject crisp while rendering a stylized movie-like finish.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          ...
          <ol className="mt-4 space-y-3 lg:space-y-4">
            {["Paste the prompt into your AI editor.", "Upload the photo and choose a cinematic or film style.", "Select a medium-to-high contrast setting.", "Run the edit and inspect the lighting depth and color saturation."].map((step, i) => (
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          <h2 className="text-xl font-bold text-neutral-900 lg:text-2xl">Best settings for cinematic edits</h2>
          <ul className="mt-4 space-y-2.5 lg:space-y-3">
            {["Model: cinematic, film, or editorial", "Resolution: 1920x1080 or higher", "Lighting: dramatic and directional", "Color: muted highlights, deep shadows"].map((item) => (
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          ...
          <p className="mt-3 text-sm leading-7 text-neutral-500 lg:text-base lg:leading-8 xl:text-lg">
            The output should look like a still from a film, with strong mood, cinematic depth,
            and a natural subject. The shot should feel intentional, not oversaturated.
          </p>
        </section>
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:gap-4">
            {[
              { href: "/prompts/creative-mood/add-mood-lighting", label: "AI prompt to add mood lighting to portrait" },
              { href: "/prompts/portrait-enhancement/magazine-cover", label: "AI prompt to turn photo into magazine cover" },
            ].map(({ href, label }) => (
