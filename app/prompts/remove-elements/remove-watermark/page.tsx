      ...
      <article className="space-y-8 lg:space-y-10">
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          ...
          <ol className="mt-4 space-y-3 lg:space-y-4">
            {[
              ...
              "Upload the image with the watermark.",
              "Select inpainting or repair mode.",
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-7 lg:rounded-3xl lg:p-8 xl:p-9">
          ...
          <ul className="mt-4 space-y-2.5 lg:space-y-3">
            {[
              "Model: inpainting or photo repair",
              "Resolution: same as the original image",
              "Lighting: match existing image lighting",
              "Detail: preserve texture and fine edges",
            ].map((item) => (
              <li
                key={item}
            ...
            {[
              {
                ...
                label: "AI prompt to remove people from photo",
              },
              {
